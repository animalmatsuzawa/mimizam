def test_get_fingerprints_by_song(mysql_database, test_song, test_fingerprints):
    """MySQL: get_fingerprints_by_songのテスト"""
    # 楽曲とフィンガープリントを追加
    mysql_database.add_song(test_song)
    mysql_database.add_fingerprints(test_song.id, test_fingerprints)

    # 取得
    result = mysql_database.get_fingerprints_by_song(test_song.id)
